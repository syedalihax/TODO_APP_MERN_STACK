                    ...
                    <div className='border border-[#00000030] flex w-[80%] h-[80%] rounded-2xl overflow-hidden shadow-xl shadow-[#00000070]'>
                        ...
                        <div className='w-[50%] h-full flex flex-col pt-10 gap-2.5 items-center px-15'>
                            ...
                            <div className=' my-3'>
                                ...
                                <h1 className='text-4xl font-medium '>WellCome Back to KeepNotes</h1>
                                <p className='text-xl font-normal '>Continue your journey</p>
                            ...
                            <form className='flex flex-col  w-full' onSubmit={(e) => { submitHandler(e) }}>
                                ...
                                <button className='text-2xl text-white bg-primary w-fit px-6 py-2 rounded-md my-5 hover:bg-primary/80 ml-auto cursor-pointer' type='submit'>Login</button>
                            </form>
                            <div className='w-full'>
                                <p className='w-full text-left'>Need an account? <u className='cursor-pointer hover:text-primary text-lg'><Link to='/signup'>SignUp</Link></u></p>
                            </div>
                        </div>

                        <div className='bg-[url("/log.jfif")] bg-cover bg-center w-[50%] h-full'>
