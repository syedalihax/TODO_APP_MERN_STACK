        ...
        <div className='bg-blue-50 fixed w-full h-full flex justify-center '>
            ...
            <div className='flex flex-col items-center border-2 border-blue-600 w-120 h-120 mt-20 rounded-2xl shadow-xl shadow-blue-500'>
                ...
                <form className=' mt-8 w-[70%] h-fit flex gap-5 justify-between flex-col' onSubmit={(e) => { submitHandler(e) }}>
                    ...
                    <button className='ml-auto text-xl text-blue-600 border-2 border-blue-500 h-fit w-fit px-6 py-1.5 rounded-full' type="submit">Login</button>
                </form>
                <p className='px-20 mt-5 w-full text-left text-blue-900 cursor-pointer'>don't have account <u className='text-blue-700 text-xl hover:font-semibold'><Link to={'/signup'}>SignUp</Link></u> now</p>
